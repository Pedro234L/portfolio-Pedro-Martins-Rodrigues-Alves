...
### 👨‍💻 Sobre
Atualmente cursando o 1º período de Análise e Desenvolvimento de Sistemas na UNICID. Sou apaixonado por resolver problemas através da tecnologia e possuo foco em Análise de Dados, Desenvolvimento Back end, Automação e Inteligência Artificial.
 
* **Habilidades Técnicas:** Python, Logica de automação e Github.
* **Habilidades Socioemocionais:** Trabalho em equipe, comunicação assertiva, pensamento crítico e adaptabilidade 
