# 🎭 Engenharia de Prompt: Criatividade e Iteração

Este repositório documenta experimentos práticos em engenharia de prompt, explorando a capacidade das IAs em adaptar estilos literários complexos e realizar edições incrementais em imagens geradas por IA.

---

## 📜 1. O Perdão do Pirata (Geração de Texto)
...
Este projeto demonstra o processo de **Prompt Encadeado**, onde novos elementos são adicionados a uma imagem base, mantendo a consistência estilística. [cite_start]Utilizamos as **Taxonomias de Bloom e Fink** para avaliar a eficácia da IA em cada etapa.
...
---
[Voltar ao topo](#-engenharia-de-prompt-criatividade-e-iteração)
